...
div.wrapper
  div(class="wrapper-background"
    :style= "{ '--hero-image': `url(${ !$vuetify.breakpoint.mobile ? HeroImg : HeroImgMobile})` }"
    )
    v-row.h-100
      v-col.h-100.d-flex(
          cols=12
        ...
        div.flex-column(style="margin: auto" v-if= "!$vuetify.breakpoint.mobile")
          div.d-flex.justify-center.mb-5
            div.mx-4(v-for="logo in logos")
              v-img(:src="logo" width="200px" height="200px")
...
export default {
  ...
  data: () => ({
    ...
    HeroImgMobile,
    logos: [ComingsoonImg],
    WelcomeText: 'Launching Soon.....',
    WelcomeQuote: 'Stay tuned!! It will be updated soon'
  })
}
</script>
<style scoped>
